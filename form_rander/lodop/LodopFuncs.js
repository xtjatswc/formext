...
function getLodop(oOBJECT,oEMBED){
    ...
    var strCLodopInstall="<br><font color='#FF00FF'>CLodop云打印服务(localhost本地)未安装启动!点击这里<a href='"+lodopPath+"CLodop_Setup_for_Win32NT.exe' target='_self'>执行安装</a>,安装后请刷新页面。</font>";
    var strCLodopUpdate="<br><font color='#FF00FF'>CLodop云打印服务需升级!点击这里<a href='"+lodopPath+"CLodop_Setup_for_Win32NT.exe' target='_self'>执行升级</a>,升级后请刷新页面。</font>";
    var LODOP;
    try{
		...
		LODOP.SET_LICENSES("北京康爱营养科技股份有限公司","F0E4BBC7C273EE56136559303C37E863","北京康愛營養科技股份有限公司","8C50733CDB43545B3781232044EB3978");
		LODOP.SET_LICENSES("THIRD LICENSE","","Beijing Ainst Nutrition Co., Ltd.","2A0688753EDA630457A0C44F62707C82");
        //===========================================================
        return LODOP;
