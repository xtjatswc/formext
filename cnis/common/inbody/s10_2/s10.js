...
s10.createPrintPage = function () {
    ...
    LODOP.ADD_PRINT_TEXT(110,193,100,20,s10.report[4].ItemValue + "cm"); //身高
    LODOP.ADD_PRINT_TEXT(107,269,100,20,s10.report[5].ItemValue); //年龄
    ...
    LODOP.ADD_PRINT_TEXT(176,154,150,20,s10.report[19].ItemValue); //身体总水分 测量值
    LODOP.ADD_PRINT_TEXT(189,130,150,20,"(" + s10.report[174].ItemValue + "~" + s10.report[175].ItemValue + ")"); //身体总水分 范围
    LODOP.ADD_PRINT_TEXT(181,221,150,20,s10.report[19].ItemValue); //身体总水分
    LODOP.ADD_PRINT_TEXT(203,154,150,20,s10.report[16].ItemValue); //蛋白质
    LODOP.ADD_PRINT_TEXT(216,130,150,20,"(" + s10.report[149].ItemValue + "~" + s10.report[148].ItemValue + ")"); //蛋白质 范围
    LODOP.ADD_PRINT_TEXT(229,154,150,20,s10.report[17].ItemValue); //无机盐
    LODOP.ADD_PRINT_TEXT(242,130,150,20,"(" + s10.report[151].ItemValue + "~" + s10.report[150].ItemValue + ")"); //无机盐 范围
    LODOP.ADD_PRINT_TEXT(255,154,150,20,s10.report[18].ItemValue); //体脂肪
    LODOP.ADD_PRINT_TEXT(268,130,150,20,"(" + s10.report[170].ItemValue + "~" + s10.report[171].ItemValue + ")"); //体脂肪 范围
    LODOP.ADD_PRINT_TEXT(189,300,150,20,s10.report[22].ItemValue); //肌肉量
    LODOP.ADD_PRINT_TEXT(202,276,150,20,"(" + s10.report[178].ItemValue + "~" + s10.report[179].ItemValue + ")"); //肌肉量 范围
    LODOP.ADD_PRINT_TEXT(209,375,150,20,s10.report[20].ItemValue); //去脂体重
    LODOP.ADD_PRINT_TEXT(222,351,150,20,"(" + s10.report[176].ItemValue + "~" + s10.report[177].ItemValue + ")"); //去脂体重 范围
    LODOP.ADD_PRINT_TEXT(229,446,150,20,s10.report[6].ItemValue); //体重
    LODOP.ADD_PRINT_TEXT(242,422,150,20,"(" + s10.report[155].ItemValue + "~" + s10.report[154].ItemValue + ")"); //体重 范围

    var leftMargin = 145;
    //肌肉脂肪分析
    var w = s10.rangeWidth2(67, 85, 115);
    LODOP.ADD_PRINT_SHAPE(4,351,132,w,9,0,1,"#808080"); //体重 %
    LODOP.ADD_PRINT_TEXT(351,leftMargin + w,150,20,s10.report[6].ItemValue); //体重 kg    

    w = s10.rangeWidth2(62, 90, 110);
    LODOP.ADD_PRINT_SHAPE(4,383,132,w,9,0,1,"#808080"); //骨骼肌 %
    LODOP.ADD_PRINT_TEXT(383,leftMargin + w,150,20,s10.report[21].ItemValue); //骨骼肌 kg    

    w = s10.rangeWidth2(61, 80, 160);
    LODOP.ADD_PRINT_SHAPE(4,414,132,w,9,0,1,"#808080"); //体脂肪 %
    LODOP.ADD_PRINT_TEXT(414,leftMargin + w,150,20,s10.report[18].ItemValue); //体脂肪 kg    

    //肥胖分析
    w = s10.rangeWidth2(23, 18.5, 23.9);
    LODOP.ADD_PRINT_SHAPE(4,498,132,w,9,0,1,"#808080"); //身体质量指数
    LODOP.ADD_PRINT_TEXT(498,leftMargin + w,150,20,s10.report[23].ItemValue); //身体质量指数 值

    w = s10.rangeWidth2(24, 10, 20);
    LODOP.ADD_PRINT_SHAPE(4,529,132,w,9,0,1,"#808080"); //体脂百分比
    LODOP.ADD_PRINT_TEXT(529,leftMargin + w,150,20,s10.report[24].ItemValue); //体脂百分比 值

    //肌肉均衡
    w = s10.rangeWidth2(73, 85, 115);
    LODOP.ADD_PRINT_SHAPE(4,618,132,w,9,0,1,"#808080"); //右上肢 %
    LODOP.ADD_PRINT_TEXT(618,leftMargin + w,150,20,s10.report[73].ItemValue); //右上肢 值
    LODOP.ADD_PRINT_TEXT(618,457,150,20,s10.report[98].ItemValue); //细胞外水分比率 右上肢

    w = s10.rangeWidth2(74, 85, 115);
    LODOP.ADD_PRINT_SHAPE(4,653,132,w,9,0,1,"#808080"); //左上肢 %
    LODOP.ADD_PRINT_TEXT(653,leftMargin + w,150,20,s10.report[74].ItemValue); //左上肢 值
    LODOP.ADD_PRINT_TEXT(653,457,150,20,s10.report[99].ItemValue); //细胞外水分比率 左上肢

    w = s10.rangeWidth2(75, 90, 110);
    LODOP.ADD_PRINT_SHAPE(4,690,132,w,9,0,1,"#808080"); //躯干 %
    LODOP.ADD_PRINT_TEXT(690,leftMargin + w,150,20,s10.report[75].ItemValue); //躯干 值
    LODOP.ADD_PRINT_TEXT(690,457,150,20,s10.report[100].ItemValue); //细胞外水分比率 躯干

    w = s10.rangeWidth2(76, 90, 110);
    LODOP.ADD_PRINT_SHAPE(4,725,132,w,9,0,1,"#808080"); //右下肢 %
    LODOP.ADD_PRINT_TEXT(725,leftMargin + w,150,20,s10.report[76].ItemValue); //右下肢 值
    LODOP.ADD_PRINT_TEXT(725,457,150,20,s10.report[101].ItemValue); //细胞外水分比率 右下肢

    w = s10.rangeWidth2(77, 90, 110);
    LODOP.ADD_PRINT_SHAPE(4,761,132,w,9,0,1,"#808080"); //左下肢 %
    LODOP.ADD_PRINT_TEXT(761,leftMargin + w,150,20,s10.report[77].ItemValue); //左下肢 值
    LODOP.ADD_PRINT_TEXT(761,457,150,20,s10.report[102].ItemValue); //细胞外水分比率 左下肢
