...
printLabel.printInit = function(){
    ...
    LODOP.ADD_PRINT_TABLE("11.59mm","1.01mm","85.01mm","31.33mm",strStyle + document.getElementById("tblNutrientadvicedetail").outerHTML);
    LODOP.SET_PRINT_STYLEA(0,"Vorient",3);
    LODOP.ADD_PRINT_HTM("1.01mm","1.01mm","85.01mm","10mm",document.getElementById("divBaseInfo").outerHTML);
    LODOP.SET_PRINT_STYLEA(0,"ItemType",1);
    LODOP.SET_PRINT_STYLEA(0,"LinkedItem",1);
    LODOP.ADD_PRINT_TEXT("43.66mm","1.32mm","21.17mm","5.29mm","第#页/共&页");
