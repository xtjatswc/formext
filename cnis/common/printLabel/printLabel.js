...
printLabel.printInit = function(){
    ...
    LODOP.ADD_PRINT_TABLE("11.59mm","1.01mm","85.01mm","28mm",strStyle + document.getElementById("tblNutrientadvicedetail").outerHTML);
    ...
    LODOP.ADD_PRINT_TEXT("41mm","1.32mm","21.17mm","5.29mm","第#页/共&页");
