...
//制剂数据
$sql = "select a.SingleMetering,a.GroupVal, b.RecipeAndProductName,a.AdviceAmount,case a.NutrientAdviceDetailRemark when '无' then '' else a.NutrientAdviceDetailRemark end NutrientAdviceDetailRemark,c.MeasureUnitName,d.MeasureUnitName minUnitName, b.wrapperType from nutrientadvicedetail a
...
<?php
//按时间段拆分
$takeOrders = explode(',', $result["TakeOrder"]);
foreach ($takeOrders as $keyOrder => $orderName) {
...
foreach ($tblDetail as $key => $value) {
    ...
    echo "<tr>
            ...
            <td>" . $value["SingleMetering"] . " ". $unit . "</td>
...
?>
            ...
            <tr>
                <td style="padding:0px">
                    <table style="margin-top:-1px;">
                        <tr>
                        <td><nobr>时间：</nobr><br/><nobr><?php echo $orderName ?></nobr></td>
